...
public class CheckoutLocators {
    ...
    public static By cancelCheckoutButton = By.id("cancel");
    ...
    public static By priceOfFirstItemFromCartList = By.xpath("(//div[@class='cart_list']//div[@class='inventory_item_price'])[1]/text()[2]");
    public static By priceOfSecondItemFromCartList = By.xpath("(//div[@class='cart_list']//div[@class='inventory_item_price'])[2]/text()[2]");
    public static By itemTotal = By.xpath("//div[@class='summary_subtotal_label']/text()[2]");
    public static By taxAmount = By.xpath("//div[@class='summary_tax_label']/text()[2]");
    public static By totalPayableAmount = By.xpath("//div[@class='summary_info_label summary_total_label']/text()[2]");
    public static By finishButton = By.id("finish");
    public static By cancelButton = By.id("finish");
